...
bool is_overlapping(entry *e1, entry *e2) {
    ...
    return get_num_mins_since_midnight(&(e1->start)) < get_num_mins_since_midnight(&(e2->end)) && get_num_mins_since_midnight(&(e2->start)) < get_num_mins_since_midnight(&(e1->end));
}
